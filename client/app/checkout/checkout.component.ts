  ...
  constructor($http, $scope, socket, $routeParams) {
    ...
    this.groups = [
      ...
      },
      {
        ...
        desc: 'Ao doar pela doebem, conseguimos mensurar o impacto do nosso trabalho e medir a destinação das doações para cada causa. Além disso o usuário, ao doar pela nossa plataforma, terá acesso a um acompanhamento personalizado sobre o impacto das suas doações.'
      },
      {
      ...
      },
      {
        ...
        desc: 'A melhor maneira de nos ajudar é fazer uma doação para as organizações recomendadas por nós ou para a própria doebem. Como segunda opção você pode nos indicar para familiares e amigos ou mesmo outros doadores por meio de suas redes sociais. Como terceira opção você pode se candidatar para nossas vagas de emprego, sugerir ideias ou dar feedback.'
      }                                         
    ];
  }
...
export default angular.module('doebemOrgApp.checkout', [ngRoute, uiBootstrap, contactForm])
  .config(routing).component('checkout', {template: require('./checkout.pug'),
