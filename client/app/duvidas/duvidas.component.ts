  ...
  constructor($http, $scope, socket, $routeParams, $sce) {
    ...
    this.groups = [
      ...
      },
      {
        ...
        desc: `"A critério da doebem" significa que iremos fazer a escolha da organização para qual a doação será destinada com base em nossos critérios e conversas com as rganizações. Essa é uma opção para facilitar sua experiência de doação, caso você não tenha nenhuma organização preferencial.`
      }
    ];
