  ...
  constructor($http, $scope, socket, $routeParams) {
    ...
    this.groups = [
      ...
      },
      {
        ...
        No momento da doação para a instituição, o doador também pode optar em acrescentar 10% acima do valor doado, que será destinado para manter as operações da doebem. 
      ...
      },
      {
        ...
        desc: `As organizações recomendadas por nós possuem impacto positivo, mensurado com base em estudos acadêmicos, muito maior do que outras organizações brasileiras. 
        Assim a mesma doação que você faria para outra organização possui muito mais valor e impacto em uma das organizações recomendadas por nós. 
        Além disso, avaliamos o profissionalismo em termos de gestão, equipe e transparência financeira de cada uma das organizações sugeridas.`,
      },
      {
        title: 'Como vocês desenvolveram os critérios de análise das organizações?',
        desc: `Estudamos diferentes modelos de análise de causa e de organizações, como a GiveWell, Giving What We Can, Charity Navigator, entre outros, 
        e elaboramos um conjunto de critérios - qualidade da gestão, transparência e impacto - que fizesse sentido no contexto brasileiro.`,
      },
      {
      ...
      },
      {
        ...
        desc: `Temos como política a avaliação imparcial, assim caso o colaborador tenha qualquer relacionamento prévio com a organização - como por exemplo, o voluntariado -, ele não poderá participar do processo de avaliação desta organização. 
        Além disso, será mencionado na avaliação caso qualquer membro da equipe da organização tenha qualquer relacionamento com a organização avaliada `,
      },
      {
        ...
        Como terceira opção, você pode se candidatar para nossas vagas de emprego, sugerir ideias ou dar sugestões.`
      }
    ];
  }
