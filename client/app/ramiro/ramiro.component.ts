...
import routing from './ramiro.routes';
import contactForm from '../../components/contact-form/contact-form.component';

declare var PagarMeCheckout: any;

export class RamiroController {
  $http;
  $scope;
  $location;
  $sce;
...
export default angular.module('doebemOrgApp.ramiro', [ngRoute, contactForm])
  .config(routing)
  .component('ramiro', { template: require('./ramiro.pug'), controller: RamiroController })
  .name;
